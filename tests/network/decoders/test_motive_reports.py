"""Tests for fleetpull.network.decoders.motive_reports.

Fixtures are synthetic, constructed in the verified envelope shape: the
utilization surfaces' captured facts -- the standard wrapped-list
envelope, rows with NO time identity, stamped from the sent
